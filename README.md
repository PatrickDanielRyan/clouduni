...
* **Jackson** A Java library that converts between JSON and Java classes.  It's used by the Spring Boot framework.
...
* **Hibernate** A Java library that converts between Entities and SQL commands.  It's used by the Spring Boot framework.
